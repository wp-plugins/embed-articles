		...
		<div class="postbox" style="padding: 10px; margin: 0px;">
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">				
					...
					-->
					<tr valign="top"><td align="right"><b>Button Location</b></td><td style="padding: 10px; background: #F5F5F5;width:100%;"><select name="display"><option value="bottom" <?=$buttom?>>bottom of post</option><option value="top" <?=$top?>>top of post</option><option value="custom" <?=$custom?>>custom location</option></select></td></tr>
					<? if ($display == 'custom') { ?>
