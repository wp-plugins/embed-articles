		...
		<div class="postbox" style="padding: 10px; margin: 0px;">
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">				
					<tr valign="top"><td align="right"><b><?php _e("API Key" ); ?></b></td><td style="padding: 10px; background: #F5F5F5;"><input type="text" name="pub_value" value="<?php echo $pub_value; ?>" size="40" <?=$_islocked?>><?=$_locker?><p>Get your own API Key Free at <a href="http://embedarticles.com/login/" target="_new">http://embedarticles.com/login/</a></p></td></tr>						
					...
					<tr valign="top"><td align="right"><b>Button Location</b></td><td style="padding: 10px; background: #F5F5F5;"><select name="display"><option value="bottom" <?=$buttom?>>bottom of post</option><option value="top" <?=$top?>>top of post</option><option value="custom" <?=$custom?>>custom location</option></select></td></tr>
					<? if ($display == 'custom') { ?>
					<tr valign="top"><td align="right"><b>Button Code</b></td><td style="padding: 10px; background: #F5F5F5;"><p>Copy and paste this button code anywhere you want it to appear...</p><?=$custom_button?></td></tr>					
					<? } ?>
					<tr valign="top"><td align="right"><b>Recommended Articles</b></td><td style="padding: 10px; background: #F5F5F5;"><select name="recommended"><option value="yes" <?=$r1?>>YES</option><option value="no" <?=$r2?>>NO</option></select><p>Displays a line of recommended trending articles with images.</p></td></tr>
					<tr valign="top"><td align="right"><b>iSnare Answers</b></td><td style="padding: 10px; background: #F5F5F5;"><select name="answers"><option value="yes" <?=$ans1?>>YES</option><option value="no" <?=$ans2?>>NO</option></select><p>Displays a portion for www.isnare.org page questions and answers.</p></td></tr>					
