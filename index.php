	...
	*/
	...
	function display_embedarticles_widget() {
		...
		if(is_single() && ($_socials == 1)) {
			$_data = '
				<table style="display: inline; max-height: 21px !important;">
					<tr valign="top" style="display: block !important; max-height: 21px !important;">						
						<td style="max-height: 20px !important; height: 20px; width: 130px; max-width: 130px; float: left !important;">
							' . $_data . '
						</td><td style="max-height: 20px !important; height: 20px; width: 130px; max-width: 130px; float: left !important;">
							...
							<iframe style="width: 110px; height: 20px;" data-twttr-rendered="true" title="Twitter Tweet Button" class="twitter-share-button twitter-tweet-button twitter-share-button twitter-count-horizontal" src="http://platform.twitter.com/widgets/tweet_button.2dbfc52aff624254c17d0ae518d60e15.en.html#_=1417158547162&amp;count=horizontal&amp;id=twitter-widget-0&amp;lang=en&amp;original_referer=' . get_permalink() . '&amp;size=m&amp;text=' . urlencode(get_the_title()) . '&amp;url=' . get_permalink() . '" allowtransparency="true" scrolling="no" id="twitter-widget-0" frameborder="0"></iframe>
							<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
						</td>					
						</td><td style="max-height: 20px !important; height: 20px; width: 130px; max-width: 130px; float: left !important;">
							<script class="inshare" type="IN/Share" data-url="' . get_permalink() . '" data-counter="right" data-showzero="true"></script>
						</td><td style="max-height: 20px !important; height: 20px; width: 130px; max-width: 130px; float: left !important;">
							<script src="https://apis.google.com/js/platform.js" async defer></script>
							<div class="g-plusone" data-annotation="inline" data-width="130" style="max-height: 20px !important; height: 20px !important; width: 130px !important; max-width: 130px !important; float: left !important;"></div>
						</td>														
					</tr>
				</table>
			';
