	...
	function display_embedarticles_widget() {
		...
		*/
		...
		if(is_single()) {
			...
			$_data .= '<a id="embedarticles_badge" href="http://embedarticles.com" data-url="'.get_permalink().'" data-key="'.get_option('embedarticles_pub_value').'" data-button-type="n">Embed Articles</a>';
