<?php 
	...
	*/
	...
	function embedarticles_buttons() {
		...
		wp_register_script( 'jquery-ui-script', '//code.jquery.com/ui/1.11.2/jquery-ui.js' );
		wp_enqueue_script( 'jquery-ui-script' );
	
		wp_register_style( 'bootstrap-style', '//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css' );
		wp_enqueue_style( 'bootstrap-style' );
		
		wp_register_style( 'bootstrap-ui-style', '//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap-theme.min.css' );
		wp_enqueue_style( 'bootstrap-ui-style' );
		
		wp_register_style( 'jquery-ui-style', '//code.jquery.com/ui/1.10.3/themes/flick/jquery-ui.css' );
	...
	function embed_articles_shortcode( $atts ) {
		...
		return $content . '<a id="embed_articles" href="http://embedarticles.com" data-url="' . urlencode($url) . '" data-key="null">Embed Articles</a> <script type="text/javascript" src="http://embedarticles.com/widget/embed.js"></script>';
	}
