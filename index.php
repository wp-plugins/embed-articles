			...
			$_data .= '
				<div class="social-bookmarks">
					<p>Did you like this article? Share it with your friends!</p>
						...
						<div class="flattr">
							<iframe style="border-width: 0px;" title="Flattr" src="//api.flattr.com/button/view/?uid=embedarticles&amp;button=compact&amp;url=http%3A%2F%2Fblog.isnare.com%2Fconvenient-strategies-for-speedy-and-wholesome-weight-loss%2F" height="20" width="110"></iframe><script id="fbwaecf">(function(i){var f,s=document.getElementById(i);f=document.createElement(\'iframe\');f.src=\'//api.flattr.com/button/view/?uid=embedarticles&button=compact&url=\'+encodeURIComponent(document.URL);f.title=\'Flattr\';f.height=20;f.width=110;f.style.borderWidth=0;s.parentNode.insertBefore(f,s);})(\'fbwaecf\');</script>
					</div>
					<div class="clear"></div>
				</div>		
			';
