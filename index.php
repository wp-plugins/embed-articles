			...
			$_data = '
				<table style="display: inline; max-height: 21px !important;">
					<tr valign="top" style="display: block !important; max-height: 21px !important;">						
						<td style="max-height: 20px !important; height: 20px; width: 90px; max-width: 90px; float: left !important;">
							' . $_data . '
						</td><td style="max-height: 20px !important; height: 20px; width: 90px; max-width: 90px; float: left !important;">
							...
							<div class="g-plusone" data-size="medium" data-href="' . get_permalink() . '" style="max-height: 20px !important; height: 20px; width: 90px; max-width: 90px; float: left !important;"></div>
