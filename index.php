		...
		<table><tr><td>
			<ul style="display: block !important; list-style: none !important;">
				<li style="display: inline !important; float: left !important;">
					<a href="http://embedarticles.com/ea?url=' . get_permalink() . '" target="_new" class="popup">
						<img src="' . plugins_url('icons/ea_64x64.png',__FILE__) . '" border="0" alt="ea">
					</a>
				</li>		
				<li style="display: inline !important; float: left !important;">
					<a href="https://www.facebook.com/sharer/sharer.php?u=' . get_permalink() . '" target="_new" class="popup">
						<img src="' . plugins_url('icons/facebook_64x64.png',__FILE__) . '" border="0" alt="facebook">
					</a>
				</li>					
				<li style="display: inline !important; float: left !important;">
					<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=' . get_permalink() . '&amp;title=' . get_the_title() . '" target="_new" class="popup">
						<img src="' . plugins_url('icons/linkedin_64x64.png',__FILE__) . '" border="0" alt="linkedin">
					</a>
				</li>	
				<li style="display: inline !important; float: left !important;">
					<a href="http://twitter.com/home?status=' . get_the_title() . '' . get_permalink() . '" target="_new" class="popup">
						<img src="' . plugins_url('icons/twitter_64x64.png',__FILE__) . '" border="0" alt="twitter">
					</a>
				</li>					
				<li style="display: inline !important; float: left !important;">
					<a href="https://plus.google.com/share?url=' . get_permalink() . '" target="_new" class="popup">
