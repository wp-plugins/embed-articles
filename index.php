<?php 
	...
	*/
	...
	function embed_admin_actions() {
		add_options_page("Embed Articles Settings", "Embed Articles Settings", 'manage_options', "Embed-Articles-Settings", "embed_admin");
	}
	...
	function add_widget_to_excerpt($content) {
		if(get_option('embedarticles_display')=="showboth") {
			return $content . display_embedarticles_widget();
		} else {
			return $content;
		}
