	...
	*/
	...
	function display_embedarticles_widget() {
		...
		if(is_single() && ($_socials == 1)) {
			$_data = '
				<table style="display: inline; max-height: 20px !important;">
					<tr valign="top">						
						<td style="max-height: 21px !important; height: 20px; width: 130px; max-width: 130px;">
							' . $_data . '
						</td><td style="max-height: 21px !important; height: 20px; width: 130px; max-width: 130px;">
						...
						</td><td style="max-height: 20px !important; height: 20px; width: 130px; max-width: 130px;">
