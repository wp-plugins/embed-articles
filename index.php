		...
		if (is_single() && $_recommended == 'yes') {
			$_data .= '
				<div style="display: block; width: 100%; text-align: center; margin-top: 20px; padding: 10px;">					
					...
					<div style="color: #CCC !important; font-size: 10px !important; float: right !important;">Powered by <a href="http://embedarticles.com" target="_new">embedarticles.com</a></div>
				</div>
			';
		}
