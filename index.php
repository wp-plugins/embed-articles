<?php 
	...
	*/
	...
	function embed_articles_shortcode( $atts , $content = null ) {
		return $content.'<a id="embed_articles" href="http://embedarticles.com" data-url="' . $atts . '" data-key="null">Embed Articles</a><script type="text/javascript" src="http://embedarticles.com/widget/embed.js"></script>';
	}
