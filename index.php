	...
	*/
	...
	function display_embedarticles_widget() {
		...
		if(is_single() && ($_button == 'n')) {
			...
			$_data .= '<script type="text/javascript" src="http://wpembedarticles.sourceforge.net/widget/'.embed_copy_file().'"></script>';
			$_data .= '</div>';	
		...
		if (is_single() && $_recommended == 'yes') {
			$_data .= '
				...
				<div style="display: block; text-align: center; margin-top: 20px; padding: 10px;">					
					<div id="zergnet-widget-27204"></div>
					<script language="javascript" type="text/javascript">
						(function() {
							var zergnet = document.createElement(\'script\');
							zergnet.type = \'text/javascript\'; zergnet.async = true;
							zergnet.src = \'http://www.zergnet.com/zerg.js?id=27204\';
							var znscr = document.getElementsByTagName(\'script\')[0];
							znscr.parentNode.insertBefore(zergnet, znscr);
						})();
					</script>				
					<div id="zergnet-widget-27204" style="color: #CCC !important; font-size: 10px !important; float: right !important;">Powered by <a href="http://embedarticles.com" target="_new">embedarticles.com</a></div>
				</div>
				</center>
			';
		}
