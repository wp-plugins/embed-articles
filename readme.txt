=== Share & Embed Articles or Posts ===
Plugin Name: Share & Embed Articles or Posts
...
7. Choices of buttons for basic customization.
8. Ability to add own custom button code for advanced customization.
9. Choices of button location as follows: A) top of post. B) bottom of post. C) Custom location.
10. Available option to include social sharing buttons like Twitter and Facebook side-by-side EmbedArticles button.
...
== Changelog ==
= 6.0.8 =
* Added embed and share tooltips
= 6.0.7 =
* Minor Fixes
= 6.0.3 - 6.0.6 =
* Minor Fixes
