...
<div class="wrap">
	...
	<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
		...
		<p>Show the button at <select name="display"><option value="bottom" <?=$display_bottom?>>bottom of post</option><option value="top" <?=$display_top?>>top of post</option></select></p>
		<p class="submit">
