...
<?
	...
	$r1 = $_socials == 'yes' ? 'selected' : "";
	$r2 = $_socials == 'no' ? 'selected' : "";
...
<div style="padding: 10px; margin-bottom: 20px; border: 1px solid #DDD;">Please do not forget to <a href="http://wordpress.org/support/view/plugin-reviews/embed-articles" target="_new">review this plugin</a>...</div>

<div style="padding-bottom: 10px; margin-bottom: 10px;">   
	<div class="wrap">      
		<span style="float: right; display: block; margin-right: 20px;"><a href="http://embedarticles.com" target="_new"><img src="http://embedarticles.com/ea-sign.png"></a></span>
		<?php    echo "<h2>" . __( 'Embed Articles Settings', '' ) . " <span style='font-size: 13px;'>[<a href='https://pledgie.com/campaigns/26781' target='_new'>Support and Donate</a>]</span></h2>"; ?>	
				...
				<table cellpadding="5" cellspacing="5">				
					...
					<tr valign="top"><td align="right"><b>Choose Buttons</b></td>
						<td>
							<table>
								<tr>
									<td><input type="radio" name="button" value="bs" <?=$b1?>></td><td><img src="http://embedarticles.com/button-bubble-right.png" alt="" border="0"></td>
								</tr><tr>									
									<td><input type="radio" name="button" value="ns" <?=$b3?>></td><td><img src="http://embedarticles.com/button-bubble-top.png" alt="" border="0"></td>
								</tr><tr>
									<td><input type="radio" name="button" value="n" <?=$b2?>></td><td><img src="http://embedarticles.com/button-compact.png" alt="" border="0"></td>									
								</tr>
								<!--
								<tr>	
									<td><input type="radio" name="button" value="nb" <?=$b5?>></td><td><img src="http://embedarticles.com/button-compact-bubble.png" alt="" border="0"></td>									
								</tr>-->
							</table>
						</td>
					</tr>
					...
					<? } ?>
					<tr valign="top"><td align="right"><b>Recommended Articles</b></td><td><select name="recommended"><option value="yes" <?=$r1?>>YES</option><option value="no" <?=$r2?>>NO</option></select> Displays a line of recommended trending articles with images.</td></tr>
...
<div style="border-bottom: 1px solid #555; padding-bottom: 10px; margin-bottom: 10px; margin-right: 25px;">
	<div class="wrap">
		<h2>Reports & Community Forums <span style='font-size: 13px;'>[<a href='https://pledgie.com/campaigns/26781' target='_new'>Support and Donate</a>]</span></h2>
