...
<?
	...
	$custom_button = '<textarea style="width: 350px; height: 64px; padding: 6px 12px; font-size: 14px;">&lt;a id="embedarticles_button" href="http://embedarticles.com" data-url="null" data-key="'.$pub_value.'">Embed Articles&lt;/a>&lt;script type="text/javascript" src="http://embedarticles.com/widget/button.js">&lt;/script></textarea>';
		...
		<div class="wrap postbox" style="padding: 10px;">	  			
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">				
					<tr valign="top"><td align="right"><b><?php _e("API Key" ); ?></b></td><td><input type="text" name="pub_value" value="<?php echo $pub_value; ?>" size="40"><p>Get your own API Key Free at <a href="http://embedarticles.com/login/" target="_new">http://embedarticles.com/login/</a></p></td></tr>						
					<tr valign="top"><td align="right"><b>Choose Buttons</b></td>
						<td>
							<input type="radio" name="button" value="bs" selected> <a href="http://embedarticles.com" id="embedarticles_button" data-url="null" data-button-type="bs" data-key="<?=$pub_value?>">Embed Articles</a><script language="javascript" src="http://embedarticles.com/widget/button.js"></script> &nbsp;&nbsp;&nbsp;
							<input type="radio" name="button" value="n"> <a href="http://embedarticles.com" id="embedarticles_button" data-url="null" data-button-type="n" data-key="<?=$pub_value?>">Embed Articles</a><script language="javascript" src="http://embedarticles.com/widget/button.js"></script>
						</td>
					</tr>
...
<div style="border-bottom: 1px solid #555; padding-bottom: 10px; margin-bottom: 10px; margin-right: 25px;">
	<div class="wrap">
		<h2>Embed Articles Archives</h2>
		<? if (!empty($pub_value) && isset($pub_value)) { ?>
		<p>
			<div id="archives">
				<ul>
					<li class="active"><a href="http://embedarticles.com/api/index.php?p=embeds&k=<?=$pub_value?>">Embed Reports</a></li>
		...
		<? } else { ?>
		<p>
			You must provide a valid API Key for the archives to work.
		</p>
		<? } ?>
	</div>
</div>
