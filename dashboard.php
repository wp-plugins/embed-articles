<div style="margin-top: 10px; margin-bottom: 10px; width: 100%; border-bottom: 1px solid #555; padding-bottom: 10px; padding-right: 20px;">
	...
	<span style="display: inline; float: left;">
		<a href="admin.php?page=embedarticles">Settings</a> | <a href="admin.php?page=embedarticles&subpage=discovery">Discovery</a> | <a href="admin.php?page=embedarticles&subpage=tools">Tools</a>
	</span>	
</div>
