<div style="margin-top: 10px; margin-bottom: 10px; width: 100%; border-bottom: 1px solid #555; padding-bottom: 10px; padding-right: 20px;">
	<a href="admin.php?page=embedarticles">Settings</a> | <a href="admin.php?page=embedarticles&subpage=discovery">Discovery</a> | <a href="admin.php?page=embedarticles&subpage=tools">Tools</a> | <script id='fb4kxgc'>(function(i){var f,s=document.getElementById(i);f=document.createElement('iframe');f.src='//api.flattr.com/button/view/?uid=embedarticles&button=compact&url=http%3A%2F%2Fembedarticles.com';f.title='Flattr';f.height=20;f.width=110;f.style.borderWidth=0;s.parentNode.insertBefore(f,s);})('fb4kxgc');</script>
</div>
...
<? } else if ($_REQUEST['subpage'] == 'discovery') { ?>
<div class="wrap">
	<?php    echo "<h2>" . __( 'Embed Articles Options', '' ) . "</h2>"; ?>
	<?php if($updated==true) { echo "Your settings have been updated!"; }?>
	<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
