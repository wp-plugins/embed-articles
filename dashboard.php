	...
	<div class="wrap">
		...
		<p>
			<div id="tabs">
				...
				<div id="embeds">
					<?
						//$_embeds = file_get_contents('http://embedarticles.com/api/?_page=' . $page . '&p=embeds&k=' . $pub_value);
						//print $_embeds;
					?>
				</div>
				<div id="pageviews">
					<?
						//$_pageviews = file_get_contents('http://embedarticles.com/api/?_page=' . $page . '&p=pageviews&k=' . $pub_value);
						//print $_pageviews;
					?>				
				</div>
			</div>
		...
		<? } else { ?>
		<p>
			You must provide a valid API Key for the reports to work.
		</p>
		<? } ?>
	</div>
</div>
