		...
		<div class="wrap postbox" style="padding: 10px;">	  			
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">				
					...
					<? } ?>
					<tr valign="top"><td align="right"><b>Recommended Articles</b></td><td><select name="recommended"><option value="yes" <?=$r1?>>YES</option><option value="no" <?=$r2?>>NO</option></select><br>Displays a line of recommended trending articles with images.</td></tr>
