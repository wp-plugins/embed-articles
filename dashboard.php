		...
		<div class="wrap postbox" style="padding: 10px;">	  			
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">
					...
					<tr valign="top"><td align="right"><b>Button Location</b></td><td><select name="display"><option value="bottom" <?=$buttom?>>bottom of post</option><option value="top" <?=$top?>>top of post</option></select></td></tr>
