...
<?
	...
	$b2 = $button == 'n' ? 'checked' : "";
	$b3 = $button == 'sq' ? 'checked' : "";
	$b4 = $button == 'c' ? 'checked' : "";
	
	$s1 = $socials == '1' ? 'checked' : "";
	$s2 = $socials == '2' ? 'checked' : "";
				...
				<table cellpadding="5" cellspacing="5">				
					...
					<tr valign="top"><td align="right"><b>Choose Buttons</b></td>
						<td>
							<table>
								<tr>
									<td><input type="radio" name="button" value="bs" <?=$b1?>></td><td><img src="http://embedarticles.com/button-1.jpg" alt="" border="0"></td>
								</tr><tr>
									<td><input type="radio" name="button" value="n" <?=$b2?>></td><td><img src="http://embedarticles.com/button-2.jpg" alt="" border="0"></td>
								</tr><tr>	
									<td><input type="radio" name="button" value="sq" <?=$b3?>></td><td><img src="http://embedarticles.com/ea-square.png" alt="" border="0"></td>
								</tr><tr>	
					...
					<tr valign="top"><td align="right"><b>Social Buttons</b></td><td><select name="socials"><option value="1" <?=$s1?>>YES</option><option value="2" <?=$s2?>>NO</option></select></td></tr>
...
<div style="border-bottom: 1px solid #555; padding-bottom: 10px; margin-bottom: 10px; margin-right: 25px;">
	<div class="wrap">
		<h2>Reports & Community Forums</h2>
