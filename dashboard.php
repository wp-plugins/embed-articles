						...
						<td>
							<table>
								<tr>
									...
									<td><input type="radio" name="button" value="c" <?=$b4?>></td><td><div><b>CUSTOM BUTTON CODE</b><br><textarea name="ct" style="width: 300px; height: 50px;"><?=stripslashes($ct)?></textarea></div></td>
								</tr>
							</table>
						</td>
					</tr>
