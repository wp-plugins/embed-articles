<?
    ...
    wp_register_script( 'embedarticles_slider_js', plugins_url( 'assets/js/jquery.liquid-slider.min.js', __FILE__ ) );
    wp_enqueue_script( 'embedarticles_slider_js' );
	
    wp_register_script( 'embedarticles_touchswipe_js', plugins_url( 'assets/js/jquery.touchSwipe.min.js', __FILE__ ) );
    wp_enqueue_script( 'embedarticles_touchswipe_js' );
	
    wp_register_script( 'embedarticles_jqeasing_js', plugins_url( 'assets/js/jquery.easing.1.3.js', __FILE__ ) );
    wp_enqueue_script( 'embedarticles_jqeasing_js' );	

    wp_register_script( 'embedarticles_slider_main_js', plugins_url( 'assets/js/slider.js', __FILE__ ) );
    wp_enqueue_script( 'embedarticles_slider_main_js' );
	
    wp_register_style( 'embedarticles_slider_css', plugins_url( 'assets/css/liquid-slider.css', __FILE__ ) );
