				...
				<table cellpadding="5" cellspacing="5">				
					...
					<tr valign="top"><td align="right"><b>Choose Buttons</b></td>
						<td>
							...
							<input type="radio" name="button" value="sq" <?=$b3?>> <img src="http://embedarticles.com/ea-square.png" alt="" border="0"> &nbsp;
							<input type="radio" name="button" value="c" <?=$b4?>> CUSTOM BUTTON CODE: <textarea name="ct" style="width: 300px; height: 50px;"><?=$ct?></textarea>
						</td>
					</tr>
