...
<?
	...
	if (empty($lock) || $lock == 'no') {
		...
		$_locker = '<a href="' . $actual_link . '&lock=yes"><img src="http://embedarticles.com/unlocked.png" border="0"></a>';
		$_islocked = "";
	} else {
		$actual_link = "http://" . $_SERVER[HTTP_HOST] . $_SERVER[REQUEST_URI];
		$_locker = '<a href="' . $actual_link . '&lock=no"><img src="http://embedarticles.com/locked.png" border="0"></a>';
		$_islocked = "readonly";
	}
