	...
	<div class="wrap">
		...
		<p>
			<div id="tabs">
				...
				<div id="embeds">
					<?
						$_embeds = file_get_contents('http://embedarticles.com/api/?p=embeds&k=' . $pub_value);
						print $_embeds;
					?>
				</div>
				<div id="pageviews">
					<?
						$_pageviews = file_get_contents('http://embedarticles.com/api/?p=pageviews&k=' . $pub_value);
						print $_pageviews;
					?>				
				</div>
			</div>
