	...
	<div class="wrap">
		...
		<p>
			<div id="archives">
				...
				<div id="archives">
					<?
						$_archives = file_get_contents('http://embedarticles.com/api/?_page=' . $page . '&p=archives&k=' . $pub_value);
						print $_archives;
					?>
				</div>
				<div id="community">
					<script type="text/javascript" src="http://embedarticles.org/plugins/embedvanilla/remote.js"></script>				
				</div>
			</div>
			<script>
				jQuery(function ($) {		
