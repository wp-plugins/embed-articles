			...
			<form name="emba_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
				...
				<table cellpadding="5" cellspacing="5">				
					...
					<tr valign="top"><td align="right"><b>Choose Buttons</b></td>
						<td>
							<input type="radio" name="button" value="bs" selected> <img src="http://embedarticles.com/button-1.jpg"> &nbsp;
							<input type="radio" name="button" value="n"> <img src="http://embedarticles.com/button-2.jpg">
						</td>
					</tr>
